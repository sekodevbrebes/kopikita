            ...
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    <div className="inline-block text-left">
                        <h2 className="text-3xl font-bold text-amber-800 mb-4 section-title">
                            Apa Kata Pelanggan Kami?
                        </h2>
                        {/* Garis kiri lebih panjang */}
                        <div className="h-[3px] w-52 mb-4 rounded-full bg-gradient-to-r from-amber-800 via-amber-500 to-transparent"></div>
